              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group text-right mt-5">
                    ...
                    <a href="javascript:void(0);" class="btn cancel_btn" data-bs-dismiss="modal" onClick={toggleModal}><i class="fa fa-times"></i>&nbsp; No</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="component-item">
              ...
              <div className="search-form">
                ...
                <div className="search-option">
                  ...
                  <div data-bs-toggle="modal" data-bs-target="#delete_pop_modal" onClick={() => toggleFilterModal(machineId)}>
              ...
              <div className="container-fluid">
                <div className="row">
                  <div className="col-md-12 text-right">
                    ...
                    {machineId != '' && isDeleteAccess && isActive == 1 ? (<button type="button" className="btn delete_btn" data-bs-toggle="modal" data-bs-target="#delete_pop_modal" onClick={() => toggleModal(machineId)}><i class="fa fa-trash-o"></i>&nbsp; Delete</button>) : (null)}
                  </div>
                </div>
              </div>
            </div>
