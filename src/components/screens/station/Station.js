            ...
            <div className="component-item">
              ...
              <div className="search-form">
                ...
                <div className="search-option">
                  ...
                  <div data-toggle="modal" data-target="#delete_pop_modal" onClick={() => toggleFilterModal(stationId)}>
              ...
              <div className="container-fluid">
                <div className="row">
                  <div className="col-md-12 text-right">
                    ...
                    {stationId != '' && isDeleteAccess && isActive == 1 ? (<button type="button" className="btn delete_btn" data-toggle="modal" data-target="#delete_pop_modal" onClick={() => toggleModal(stationId)}><i class="fa fa-trash-o"></i>&nbsp; Delete</button>) : (null)}
                  </div>
                </div>
              </div>
            </div>
